...
import PremiumBundleOfferAd from './components/PremiumBundleOfferAd';
...
function App() {
  ...
  useEffect(() => {
    // Hide offer completely after July 5th
  ...
  return (
    <div className="overflow-x-clip w-full relative min-h-screen">
      ...
      {/* ──── OFFER BANNER ──── */}
      {isOfferLive && <PremiumOfferBanner onReserve={() => setTicketFormOpen(true)} />}
      ...
      <div className="-mt-[100vh] relative z-10 flex flex-col w-full">
        <PremiumBundleOfferAd onReserve={() => setTicketFormOpen(true)} />
        {/* ──── LINEUP SECTION ──── */}
        <Lineup />
      </div>
